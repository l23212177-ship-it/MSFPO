...
Nombre del alumno: Gael Sebastian Andrade Arellano 
Número de control: 23212177
Correo institucional: L23212177@tectijuana.edu.mx
...
den = [C*L,C*R,1]
sys = ctrl.tf (num,den)
print(f"Funcion de tranferencia: {sys}\n")
...
print(f"El valor de la capacitancia Cr es de {Rr} Ohms.\n")
print(f"El valor de la capacitancia Cr es de {Ce} Faradios.\n")
